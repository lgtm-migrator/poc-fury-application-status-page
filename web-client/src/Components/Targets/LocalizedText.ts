...
export class LocalizedText extends BaseLocalizedText {
  ...
  public title(target: string) {
    return this.translate("Target Title", { target });
  }
  ...
  public healthyStatusMessage(group: string) {
    return this.translate("Target Status Healthy", { group });
  }

  public passedHealthChecks(totalchecks: number) {
    return this.translate("Target Health Checks Passed", {
      totalchecks: totalchecks.toString(),
    });
  }

  public failedHealthChecks(failedchecks: number, totalchecks: number) {
    return this.translate("Target Health Checks Failed", {
      failedchecks: failedchecks.toString(),
      totalchecks: totalchecks.toString(),
    });
  }
}
